      ...
      <el-aside width="200px" style="background-color: #324057">
        <el-menu class="left">
          ...
          <el-submenu index="1">
            ...
            <el-menu-item class="fg" index="1-2" @click="shop">商家列表</el-menu-item>
  ...
  methods: {
    ...
    handleDelete(index, row) {
     ...
     handleSizeChange(val) {
      ...
      this.num=val-1
      this.$http({
        url: `https://elm.cangdu.org/shopping/restaurants?latitude=39.90469&longitude=116.407173&offset=${this.num*20}&limit=20`,
        method: "get"
      }).then(res => {
